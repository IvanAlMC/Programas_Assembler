...
%macro generate_random 1
    ...
    mov     eax, 0
    call    srand       ;this is a c fuction to generate a seed to randon numbers

    ; Generate randon numbers
    call    rand        ;this is a c fuction to generate a randon numbers     
    mov     ebx, %1     ;move the first parameter to ebx
    xor     edx, edx    ;clear the edx register
    div     ebx         ;divide the parameter
    add     edx, 1      ;The result of division is in edx
...
segment .text
    extern printf   ;This is a fuction of c to print
    extern rand     ;This is a fuction of c to generate random number
    extern srand    ;This is a fuction of c to generate a seed to randon number
    global asm_main
